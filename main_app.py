# ==============================================================================
# title              : main_app.py
# description        : This is the flask app for BERT QNA Chinese DEMO which receives the request and provide response.
...
# json_json() function is used to convert the input data i.e paragraph and question into the SQUAD like format, then we will be storing this data in a file named input_chinese.json which is used as prediction file in run_squad command that you will see further in submitted_form() function.
...
def submitted_form():
  ...
  --predict_file=input_chinese.json \
  --init_checkpoint=bert/model/chinese_fuzzy_model.ckpt-13913 \
  --max_seq_length=384 \
  --do_lower_case=False \
  --doc_stride=128 \
  --do_train=False \

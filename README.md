...
## Instructions to set up the Bert QNA Chinese Demo on Local system

1. Clone the repository in your system.
2. Download the model file from https://drive.google.com/file/d/1VbAxAX9uFiYTGwXmD6cPpvllWqYCf1MK/view?usp=sharing and unzip it in /bert directory.
